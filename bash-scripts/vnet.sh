...
# subnetsArray="(Subnet1 10.1.0.0/24 Subnet2 10.1.1.0/24 Subnet3 10.1.2.0/24)"
# subnets=3
subnet1="Subnet1"
...
#     do   
#         az network vnet subnet create --resource-group $resourcegroup --vnet-name $vnetname --subnet-name ${subnetsArray[$i]} --subnet-prefix ${subnetsArray[$(i + 1)]}
#     done
